...
class Inventory:
    def __init__(self):
        ...
        self.equip_inv_pos_x = self.inv_pos_x + self.inv_width + 5
    ...
    def draw_inventory(self, screen, player):
        ...
        screen.blit(self.equip_inv_image, (self.equip_inv_pos_x, self.inv_pos_y))
    ...
    def get_item_rects(self):
        ...
        for i, item in enumerate(self.items):
            rect = pygame.Rect(
                10 + self.inv_pos_x,
                title_height + 50 * i + 10 + self.inv_pos_y,
                self.inv_width - 20,
                40,
            )
            rects.append(rect)
